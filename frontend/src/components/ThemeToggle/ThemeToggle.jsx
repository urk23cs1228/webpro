  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: '0 4px 6px var(--color-shadow-primary)',
    ...
    >
      <div className="w-6 h-6 flex items-center justify-center">
        {theme === 'light' ? (
          <svg className="w-5 h-5 transition-transform duration-300 hover:rotate-180" fill="currentColor" viewBox="0 0 20 20">
